...
urlpatterns = [
    ...
    path('profile/saved/', acc_views.profilesaved, name='profilesaved'),
    ...
    path('notifications/', acc_views.notifications, name='notifications'),
    path('search/', acc_views.search, name='search'),
    path('chatview/', include('chats.urls')),
]
if settings.DEBUG:
